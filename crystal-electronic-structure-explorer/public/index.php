...
<body class="dark-theme">
    ...
    <main class="app-container" id="app-layout">
        <!-- Combined Panel: 3D Visualizer (Crystal + Reciprocal BZ) -->
        <section class="view-panel" id="combined-panel" aria-label="3D Visualizer: Crystal and Reciprocal Space">
            <div class="panel-header-row">
                <h2 class="panel-title">3D Space (Real vs Reciprocal)</h2>
                <div class="slider-rule-container">
                    <span class="slider-label">Real Space (Crystal)</span>
                    <input type="range" id="blend-slider" min="0" max="1" step="0.01" value="0.5" class="blend-slider">
                    <span class="slider-label">Reciprocal Space (BZ)</span>
                </div>
            </div>
            <div class="canvas-container" id="combined-canvas"></div>
            <div class="panel-controls combined-controls">
                ...
                <div class="control-group">
                    <strong>Reciprocal Space:</strong>
                    <label><input type="checkbox" id="toggle-bz" checked> Show BZ Boundary</label>
                    <label><input type="checkbox" id="toggle-kpath" checked> Show k-Path</label>
                    <label><input type="checkbox" id="toggle-symmetry-pts" checked> Show Special Points</label>
                </div>
            </div>
        </section>
